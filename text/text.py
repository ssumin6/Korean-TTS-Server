...
_symbol_to_id = {}
_id_to_symbol = {}
cleaner_names = hparams.text_cleaners[0]
...
if __name__ == "__main__":
  ...
  '''
  print(tacotron.utils.text.text_to_sequence('this is test sentence.? ', ['english_cleaners']))
  print(tacotron.utils.text.text_to_sequence('테스트 문장입니다.? ', ['korean_cleaners']))
  print(tacotron.utils.text._clean_text('AB테스트 문장입니다.? ', ['korean_cleaners']))
  print(tacotron.utils.text._clean_text('mp3 파일을 홈페이지에서 다운로드 받으시기 바랍니다.',['korean_cleaners']))
  print(tacotron.utils.text._clean_text("마가렛 대처의 별명은 '철의 여인'이었다.", ['korean_cleaners']))
  print(tacotron.utils.text._clean_text("제 전화번호는 01012345678이에요.", ['korean_cleaners']))
  print(tacotron.utils.text._clean_text("‘아줌마’는 결혼한 여자를 뜻한다.", ['korean_cleaners']))
  print(tacotron.utils.text.text_to_sequence("‘아줌마’는 결혼한 여자를 뜻한다.", ['korean_cleaners']))
  '''
